...
namespace SimpleBlog.Controllers
{
    public class PostsController : Controller
    {
        ...
        {
            //var baseQuery = Database.Session.Query<Post>().Where(t => t.IsDeleted);
            ...
            {
                Posts = new Infrastructure.PagedData<Post>(posts, totalPostCount, page, PostsPerPage)
            });
        }
